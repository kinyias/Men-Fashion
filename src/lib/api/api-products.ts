...
export const getProducts = async (
  ...
  if (queryParams.madanhmuc)
    params.append('madanhmuc', queryParams.madanhmuc.toString());
  if (queryParams.maloaisanpham)
    params.append('maloaisanpham', queryParams.maloaisanpham.toString());
  if (queryParams.mathuonghieu)
    params.append('mathuonghieu', queryParams.mathuonghieu.toString());
...
export const getProductsWithVariant = async (
  ...
  const response = await api.get(
    `/api/sanpham/with-variants?${params.toString()}`
  );
  return response.data;
};
...
export const updateProduct = async (
  id: number,
  data: Partial<CreateSanPhamData>
): Promise<SanPham> => {
...
export const advancedSearchProducts = async (
  ...
  const response = await api.get(
    `/api/sanpham/advanced-search?${params.toString()}`
  );
  return response.data;
};
...
export const getCartProducts = async (
  items: { ma: number; bienThe: { mamausac: number; makichco: number } }[]
): Promise<SanPhamWithRatingResonse> => {
