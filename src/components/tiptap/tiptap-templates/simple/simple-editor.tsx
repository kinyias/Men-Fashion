...
import { TableButton } from "@/components/tiptap/tiptap-ui/table-button"
import {
  HighlightPopover,
  HighlightContent,
  HighlighterButton,
...
export function SimpleEditor({onChange, content}: {onChange: (html: string) => void; content: string}) {
